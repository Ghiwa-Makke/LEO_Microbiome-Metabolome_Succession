...
# Set sample name
Sample_Name = "LEO_East"

# Load in data

peak.2.peak = read.csv("output/LEO_East_All-Trans_peak.2.peak.csv") # Load in the peak.2.peak file for all/bulk transformations
num.trans = read.csv("output/LEO_East_All-Trans_num.peak.trans.csv") # Load in the num.peak.trans file for all/bulk transformations
...
net.dist = distances(net) # time consuming
