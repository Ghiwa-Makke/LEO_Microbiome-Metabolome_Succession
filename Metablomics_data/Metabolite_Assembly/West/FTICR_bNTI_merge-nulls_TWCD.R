...
data = read.csv("output/Processed_LEO_West_Data.csv", row.names = 1) # Importing the organismal data  
tree = read.tree("output/LEO_West_Weighted_All-Trans_UPGMA.tre") # Importing the tree
