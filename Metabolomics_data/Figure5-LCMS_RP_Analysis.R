...
RP_full <- read.csv("output_tables/LMM_norm_auc.csv", check.names = F)
...
## 5.3. Significant compound classs ----------------------------------------------
...
print(final_plot)
ggsave("output_figures/Fig5.png", final_plot, width = 7.25, height = 6, dpi = 300)
