...
data = read.csv("output/Processed_LEO_West_Data.csv", row.names = 1) # Keeping data and mol-data seperate to ensure they are unaltered
...
for(i in start_peak:(nrow(data)-1)){ # I cannot stress the importance of the "-1" here...
  ...
  # Creating a data matrix to ensure no repeat or negative differences
