...
## Bare
ML_Bare <- read.csv("ML/Bare_ML_ft.csv")%>%
...
Bare$Type <- "Bare"
## Biocrust
ML_Biocrust <- read.csv("ML/Biocrust_ML_ft.csv")%>%
...
## Moss
ML_Moss <- read.csv("ML/Moss_ML_ft.csv")%>%
...
ggsave("output_figures/combined_contour_plot.png", plot = combined_plot, width = 6, height = 8, dpi = 300)
