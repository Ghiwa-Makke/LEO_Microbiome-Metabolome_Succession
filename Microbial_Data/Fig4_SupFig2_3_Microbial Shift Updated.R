...
# Combined-Fig4 ----------
Fig4 <- (Ord_16S + microb_shannon_diversity_plot) /
  Phylum_byType_3bars +
  plot_layout(heights = c(1, 1.3), guides = "collect") &
  theme(
    plot.tag = element_text(size = 9, face = "bold"),
    legend.position = "right"
  )
Fig4
ggsave(filename = "output_figs/Fig4.png", plot = Fig4, width = 6, height = 4.5 , dpi = 300, units = "in")
...
# Combined-SupFigS2 ----------
SupFigS2 <- (ord_metag + shannon_all) /(singlem_tax_plot2)+
  plot_layout(heights = c(1, 1.3), guides = "collect") &
  theme(
    plot.tag = element_text(size = 9, face = "bold"),
    legend.position = "right"
...
SupFigS2
ggsave(filename = "output_figs/SupFigS2.png", plot = SupFigS2, width = 6, height = 4.5 , dpi = 300, units = "in")
...
# Combined-SupFigS3 ----------
SupFigS3 <- (ord_its + fungal_shannon_diversity_plot_cleaned) /(its_tax_plot_type)+
...
SupFigS3
ggsave(filename = "output_figs/SupFigS3.png", plot = SupFigS3, width = 6, height = 4.5 , dpi = 300, units = "in")
