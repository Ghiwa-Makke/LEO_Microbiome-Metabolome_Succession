...
ggsave('output_figs/FigS1.png', final_plot_cooccurance, height = 4.5, width = 7.25, units = "in", dpi = 300, bg = "white")
...
# Display the plot
met_network_plot
ggsave('output_figs/Fig3.png', met_network_plot, height = 4.5, width = 7.25, units = "in", dpi = 300, bg= "white")
...
# dataframe ---------------------------------------------------------------
Network_data <- met_net_df %>%
  select(Name, Domain, Phylum, Class, Order, Family, Genus, Species, receiver_counts, donor_counts, main_role, module, Ki, Zi, Pi, roles, Degree, Clustering_coefficient, Betweenness, Eccentricity, Closeness, Hub_score, origin)

write.csv(Network_data, "Data_S2.csv", row.names = F)
